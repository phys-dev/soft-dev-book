...
Поиск имён осуществляется в четырёх областях видимости:
...
По умолчанию присваивание создаёт локальную переменную:
...
- Поиск имён осуществляется по правилу LEGB
- Присваивание создаёт локальные переменные (можно изменить через `global`/`nonlocal`)
