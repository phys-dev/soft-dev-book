...
Python представляет собой высокоуровневый мультипарадигменный язык программирования с динамической типизацией, о коде на котором часто говорят, что он почти как псевдокод, в котором очень мощные идеи выражаются буквально в нескольких строках и при этом легко читаются.
...
Генераторы множеств (set comprehensions) строятся так же легко, как списки и словари.
