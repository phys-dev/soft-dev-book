...
Сейчас поддерживаются версии Python 3.X. Поддержка Python 2.7 прекратилась в 2020 году. Весь код в книге рассчитан на Python 3.10 и новее.
...
В отличие от многих языков, в Python нет унарных операторов инкремента (x++) и декремента (x--).
...
Список — аналог массива в Python, но его размер можно менять, а элементы могут быть разных типов:
...
Множество — неупорядоченная коллекция различных элементов. Для начала простой пример:
