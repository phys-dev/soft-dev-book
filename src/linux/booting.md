...
Разбираться в этой цепочке стоит по вполне практической причине: когда система не загружается, диагноз ставится по тому, **на каком именно звене** всё остановилось. Экран с ошибкой загрузчика и паника ядра — это совершенно разные неисправности с разными способами починки.
