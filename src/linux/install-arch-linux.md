...
2. Введи имя виртуальной машины и выберите тип операционной системы **Linux** и версию **Arch Linux (64-bit)**.
3. Выдели необходимое количество оперативной памяти (рекомендуется не менее 2 ГБ).
4. Создай новый виртуальный жесткий диск и выберите формат VDI.
...
1. Запусти виртуальную машину и загрузитесь с ISO образа Arch Linux.
...
3. Запусти виртуальную машину и загрузитесь с ISO образа Arch Linux.
