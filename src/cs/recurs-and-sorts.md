...
* Выберем какое-нибудь число — пусть это будет 4, назовём его опорным. Все элементы, меньшие опоры, переложим в один массив, все большие — в другой, а саму опору (и равные ей) оставим посередине. Тогда элементы слева будут меньше опоры, а справа — больше:
