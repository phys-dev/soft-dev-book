...
Перебирать всё подряд слишком медленно. Ответ, который придумали для этой задачи, элегантен: научиться **вычислять** номер ячейки прямо из ключа. Именно этим занимаются хеш-функции, и на них построены словари и множества, которыми ты пользуешься каждый день.
