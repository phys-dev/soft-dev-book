...
Для физика этот материал ложится на уже знакомый фундамент. Задача обучения модели — это задача оптимизации; функция потерь — функционал, который минимизируют; регуляризация — способ сделать некорректную задачу корректной. Всё это ты уже видел, просто под другими названиями.
