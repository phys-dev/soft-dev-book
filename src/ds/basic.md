...
Для физика данный материал ложится на уже знакомый фундамент. Задача обучения модели сводится к задаче оптимизации, функция потерь к минимизируемому функционалу, а регуляризация к способу сделать некорректную задачу корректной. Всё это ты уже видел, просто под другими названиями.
