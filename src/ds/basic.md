...
Прежде чем браться за конкретные алгоритмы, договоримся о понятиях. Терминология, сложившаяся в машинном обучении стихийно, сбивает с толку: одно и то же называют по-разному, а за привычными словами вроде «модель» или «обучение», заимствованными из обихода, стоит не совсем то, что в физике.
...
Разметки `y` нет или она не используется. Алгоритм ищет внутренние структуры, закономерности и связи, спрятанные в самих данных.
...
## Основные типы задач
Внутри этих двух парадигм выделяют несколько типовых постановок, закреплённых практикой.
...
На качество обученной модели влияет всё сразу, и качество собранных данных, и выбор алгоритма, и его гиперпараметры, и аккуратность самой процедуры обучения.
