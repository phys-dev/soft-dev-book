...
Стоит нарисовать эти данные на плоскости, и видно: объекты одного класса собираются каждый в своей области пространства признаков.
...
Что именно считать «близостью», решает выбранная метрика.
...
Мы разобрали, как линейная модель начинает выдавать не метку, а вероятность, и какими метриками её после этого оценивают: Precision, Recall, F1, ROC-AUC. Ключевым понятием оказался **отступ (margin)** — он связывает линейный отклик модели с качеством классификации и лежит в основе log loss.
...
#### Мудрость толпы
На ярмарке разыгрывали лотерею: нужно было на глаз угадать вес быка. Участвовало около 800 человек, бык весил 1198 фунтов, точно не угадал никто, а среднее арифметическое всех догадок дало 1197 фунтов.

Почему так? Каждый ошибался в свою сторону, опираясь на собственный «независимый» опыт, и при усреднении ошибки погасили друг друга. Ровно так же ведёт себя случайная погрешность при усреднении серии измерений, и на этом же держится идея ансамблей.
...
Обе задачи этого раздела решаются без учителя, и обе нужны в тот момент, когда о данных ещё ничего не известно. PCA и t-SNE позволяют увидеть многомерную выборку глазами; k-средних, агломеративная кластеризация и DBSCAN раскладывают её на группы. Важно помнить общее свойство: правильного ответа, с которым можно сверить результат, здесь нет — оценивать его придётся по физическому смыслу.
