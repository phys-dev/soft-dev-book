...
> Опирается на главу [«Внутреннее устройство Linux»](../linux/structure.md): процессы, состояния, сигналы и планировщик.
...
- Вывод `ps`, снятый после повторного входа, — доказательство, что процесс жив.
