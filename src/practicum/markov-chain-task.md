...
> Опирается на главу [«Как это работает? Технические основы»](../ai/basic.md): цепь Маркова — простейшая языковая модель, и на ней хорошо видно, откуда у больших моделей берётся и связность, и склонность выдумывать.
