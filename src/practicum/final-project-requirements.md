...
> Опирается на всю книгу разом. Прежде всего на главы [«Требования к коду»](../dev/python/requirements.md), [«Жизненный цикл ПО»](../dev/life.md) и [«От скрипта к приложению»](../dev/app.md) — оттуда требования к сборке, тестам и документации. За примерами того, как выглядит доведённая до конца работа, иди в часть [«Учимся у других»](../examples/intro.md).
...
Репозитория-заготовки у этого задания нет: репозиторий заводишь сам, и его устройство — часть работы. Как он должен быть устроен, разобрано в главе [«Git»](../dev/git.md), а что положить в конвейер сборки — в главе [«Жизненный цикл ПО»](../dev/life.md).
