...
Этот пример стоит особняком среди остальных: здесь нет ни пучков, ни разностных схем. Зато он показывает архитектуру типичного современного веб-сервиса — а именно так сегодня устроены системы управления установками, электронные журналы экспериментов и порталы доступа к данным. Разобравшись с этим примером, ты сможешь написать сервис, который отдаёт данные твоего эксперимента по HTTP.
