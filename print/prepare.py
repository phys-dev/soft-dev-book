...
# --- Разбиение на тома ----------------------------------------------
# Книга выходит в двух частях. Граница проходит не по темам, а по способу
# работы: первую часть читают, вторую делают руками. В теорию входят
# инструменты, система, алгоритмы, устройство языка, инженерные практики,
# данные и ускорение; в практику — разбор реальных программ институтов
# СО РАН и задания для самостоятельной работы.
VOLUMES = {
    1: {
        "title": "Теория",
        "parts": ["Собираем инструменты", "Осваиваем Linux",
                  "Разбираемся в алгоритмах", "Погружаемся в Python",
                  "Пишем надёжный код", "Ускоряем код"],
        "abstract": (
            "Первая часть пособия — то, что нужно прочитать. Рабочая среда "
            "и инструменты разработчика, операционная система GNU/Linux, "
            "алгоритмы и структуры данных, устройство языка Python, "
            "инженерные практики от жизненного цикла программы до баз "
            "данных и способы ускорить расчёт — от профилирования "
            "до вычислений на графических ускорителях."),
    },
    2: {
        "title": "Практика",
        "parts": ["Обрабатываем данные", "Учимся у других",
                  "Работаем самостоятельно"],
        "abstract": (
            "Вторая часть пособия — то, что делают руками. Обработка и "
            "визуализация данных эксперимента, машинное обучение и "
            "нейронные сети, а затем разбор "
            "настоящих программ, которыми считают физику в институтах СО "
            "РАН: расчёт динамики пучка, оптимизация огибающей, коррекция "
            "орбиты, цифровой двойник ускорителя, мультиагентный помощник "
            "оператора и автономный исследователь на языковых моделях. "
            "Завершают часть задания для самостоятельной работы."),
    },
}
