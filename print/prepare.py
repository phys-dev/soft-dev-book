...
VOLUMES = {
    1: {
        ...
        "abstract": (
            "Первая часть — то, что нужно прочитать: инструменты "
            "разработчика, GNU/Linux, алгоритмы и структуры данных, "
            "устройство языка Python, инженерные практики от требований "
            "к коду до баз данных и способы ускорить расчёт вплоть до "
            "графических ускорителей. От общих курсов программирования "
            "пособие отличается тем, что весь материал подобран под "
            "задачи физического эксперимента."),
    },
    2: {
        "title": "Практика",
        ...
        "abstract": (
            "Вторая часть — то, что делают руками: обработка и "
            "визуализация данных, машинное обучение и нейронные сети, "
            "а затем разбор программ, которыми считают физику "
            "в институтах СО РАН, — от динамики пучка до цифрового "
            "двойника ускорителя. Разбираются работающие коды установок, "
            "а не учебные примеры. Завершают часть задания для "
