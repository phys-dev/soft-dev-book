...
% Число рецензентов уточняется в ИПЦ: образец выходных данных даёт
% «Рецензент», а выписка из протокола кафедры говорит о «рецензиях»
% и «замечаниях рецензентов» во множественном числе. Оставлено место
% под двоих; лишнюю строку убрать, если хватит одного.
\textit{Рецензенты}\\
