...
\usepackage[paperwidth=148mm,paperheight=210mm,
            top=17mm,left=17mm,right=17mm,bottom=20mm,
            footskip=10mm,headsep=6mm]{geometry}
...
\titlespacing*{\section}{0pt}{12pt plus 3pt}{6pt}
...
%% --- прочее ------------------------------------------------------
\setlist{nosep,leftmargin=6mm,topsep=3pt}
...
\newcommand*\pandocbounded[1]{%
  \sbox\pandoc@box{#1}%
  \Gscale@div\@tempa{0.42\textheight}{\dimexpr\ht\pandoc@box+\dp\pandoc@box\relax}%
...
\begin{center}
  ...
  {\LARGE\bfseries В ФИЗИЧЕСКИХ ИССЛЕДОВАНИЯХ}\\[10mm]
...
исследованиях : учеб. пособие / В.\,В.~Федоров ; Новосиб. гос. ун-т.
--- Новосибирск : ИПЦ НГУ, 2026. --- \pageref{LastPage}~с.
\vspace{3mm}

ISBN 978-5-4437-XXXX-X
\vspace{4mm}

Пособие знакомит студентов физических специальностей с инженерной
стороной научной работы: операционной системой GNU/Linux, языком Python
и его научными библиотеками, алгоритмами и структурами данных, основами
вычислительной физики, практиками разработки и сопровождения программ,
обработкой и анализом данных, машинным обучением, а также способами
профилирования и ускорения программ вплоть до вычислений на графических
ускорителях. Материал построен на разборе реальных кодов, применяемых
в институтах СО РАН, и сопровождается задачами для самостоятельной работы.

Предназначено для студентов третьего курса физического факультета НГУ,
изучающих дисциплину <<Применение Python в физических исследованиях>>,
и будет полезно всем, кто разрабатывает программное обеспечение
...
Рекомендовано к печати кафедрой физики ускорителей\\
физического факультета НГУ (протокол №~\underline{\hspace{12mm}}
от \underline{\hspace{20mm}})
\vfill

\noindent
\begin{tabular}{@{}p{34mm}@{}p{55mm}@{}}
                       & \copyright{} Новосибирский государственный\\
ISBN 978-5-4437-XXXX-X & \phantom{\copyright{}} университет, 2026\\
...
\begin{tabular}{@{}l@{}}
Подписано в печать \underline{\hspace{20mm}}\quad Формат 60\,$$\times$$\,84/16\\
Офсетная печать. Уч.-изд. л. \underline{\hspace{12mm}}\quad
