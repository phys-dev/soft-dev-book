...
case "${1:-all}" in
  1) build_volume 1 "С чего начинается работа" "$A1" ;;
  2) build_volume 2 "Когда данных много, а времени мало" "$A2" ;;
  *) build_volume 1 "С чего начинается работа" "$A1"
     build_volume 2 "Когда данных много, а времени мало" "$A2" ;;
esac
